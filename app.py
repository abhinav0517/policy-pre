...
expected_columns = ["age", "bmi", "children", "charges", "sex", "smoker", "region_northeast", "region_northwest", "region_southeast"]
...
# Reorder and fill missing features to match scaler training data
...
if st.button("Predict"):
    ...
    feature_importance = pd.Series(model.feature_importances_, index=scaler.feature_names_in_).sort_values(ascending=False)
